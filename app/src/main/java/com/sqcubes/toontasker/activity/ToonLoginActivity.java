 ...
 */
public class ToonLoginActivity extends Activity {
    private final static String TAG = ToonLoginActivity.class.getName();
    /**
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final ToonClient mToon;

        UserLoginTask(Context context, String email, String password) {
            mContext = context;
            mEmail = email;
            mPassword = password;
            mToon = new ToonAndroidClient(mContext);
        }

        @Override
        protected Boolean doInBackground(Void... params) {
            try {
                return mToon.authenticate(mEmail, mPassword);
            } catch (ToonException e) {
                Log.w(TAG, "Toon authentication failed", e);
                return false;
            }
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                NotificationHelper.clear(mContext, NotificationHelper.LOGIN_REQUIRED_NOTIFICATION_ID);
                finish();
            } else {
